...
class VisualCliente extends JPanel implements Runnable{
    ...
    public void run() {
            ...
            try{
                while(escucha==null || dirIP==null || grupo==null){
    ...
    private class CambiarGrupo implements ItemListener {
        ...
        public void itemStateChanged(ItemEvent e) {
            try {
                if(listaDesplegable.getSelectedIndex()==1){
                ...
                }else if(listaDesplegable.getSelectedIndex()==0){
                    listaDesplegable.setBackground(Color.white);
    ...
    private class EnviarTexto implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            try {
                ...
                if(!campo1.getText().isEmpty() && listaDesplegable.getSelectedIndex()!=0) {
