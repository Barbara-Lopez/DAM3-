...
?>
    ...
    <a href='ejercicio10.php?accion=comprar' class='btn btn-primary'>Comprar</a>
<?php
} else {
?>
...
<table class='table'>
    <thead>
    <tr><th>Nombre</th><th>Descripción</th><th>Precio</th><th>Favorito</th><th>Detalle</th><th>Comprar</th></tr>
    </thead>
    <tbody>
    <?php
    foreach ($productos as $id => $producto) {
        ?>
        <tr>
            <td style="<?= esFavorito($id)? "color:red": ""?>"><?= $producto['nombre'] ?></td>
            <td><?= $producto['descripción'] ?></td>
            <td><?= $producto['precio'] ?></td>
            <td><a href='ejercicio10.php?accion=favorito&idProducto=<?= $id ?>'>Favorito</a></td>
            <td><a href='ejercicio10.php?accion=detalle&idProducto=<?= $id ?>'>Detalle</a></td>
            <td><a href='ejercicio10.php?accion=insertar&idProducto=<?= $id ?>'>Comprar</a></td>
        </tr>
        <?php
    }
    ?>
